from modules.file_io import read_disciplines_from_file, write_report_to_file
from modules.reports import generate_report1, generate_report2, generate_report3, show_all_disciplines
